...
- Found in inheritance/ExtendedInheritance.sol [Line: 16](inheritance/ExtendedInheritance.sol#L16)
...
- Found in InternalFunctions.sol [Line: 12](InternalFunctions.sol#L12)
...
- Found in inheritance/ExtendedInheritance.sol [Line: 21](inheritance/ExtendedInheritance.sol#L21)
...
- Found in inheritance/IContractInheritance.sol [Line: 2](inheritance/IContractInheritance.sol#L2)

	```solidity
	pragma solidity >=0.8.0;
	```

- Found in inheritance/InheritanceBase.sol [Line: 2](inheritance/InheritanceBase.sol#L2)
...
- Found in StateVariables.sol [Line: 58](StateVariables.sol#L58)
...
- Found in StateVariables.sol [Line: 47](StateVariables.sol#L47)

	```solidity
	    function setAddrNoZeroError(address newAddr) public {
	```

- Found in StateVariables.sol [Line: 52](StateVariables.sol#L52)

	```solidity
	    function setAddrNoZeroRequire(address newAddr) public {
	```

- Found in StateVariables.sol [Line: 57](StateVariables.sol#L57)

	```solidity
	    function setAddrNoCheck(address newAddr) public {
	```

- Found in StateVariables.sol [Line: 61](StateVariables.sol#L61)

	```solidity
	    function setEmptyAlteredNumbers(
	```

- Found in StateVariables.sol [Line: 71](StateVariables.sol#L71)
...
- Found in inheritance/ExtendedInheritance.sol [Line: 7](inheritance/ExtendedInheritance.sol#L7)

	```solidity
	    event DoSomethingElse(uint256 somethingElse);
	```

- Found in inheritance/InheritanceBase.sol [Line: 7](inheritance/InheritanceBase.sol#L7)
...
- Found in StateVariables.sol [Line: 2](StateVariables.sol#L2)

	```solidity
	pragma solidity 0.8.20;
	```

- Found in inheritance/ExtendedInheritance.sol [Line: 2](inheritance/ExtendedInheritance.sol#L2)
...
- Found in InternalFunctions.sol [Line: 18](InternalFunctions.sol#L18)

	```solidity
	    modifier onlyOwner() {
	```

- Found in OnceModifierExample.sol [Line: 6](OnceModifierExample.sol#L6)
...
- Found in OnceModifierExample.sol [Line: 10](OnceModifierExample.sol#L10)
...
- Found in InternalFunctions.sol [Line: 28](InternalFunctions.sol#L28)
...
- Found in Counter.sol [Line: 4](Counter.sol#L4)
...
- Found in InconsistentUints.sol [Line: 3](InconsistentUints.sol#L3)
